...
type Configuration struct {
	...
	// Jokes provides configuration for jokes service.
	Jokes Jokes
}
...
type Jokes struct {
	...
	// NameSvcURL provides a URL of the Name service
	NameSvcURL string

	// Categories specifies joke categories
	Categories []string

	// JokesSvcURL provides a URL of the Name service
	JokesSvcURL string
}

func (c *Jokes) overrideFrom(o *Jokes) {
	overrideString(&c.NameSvcURL, &o.NameSvcURL)
	overrideStrings(&c.Categories, &o.Categories)
	overrideString(&c.JokesSvcURL, &o.JokesSvcURL)
